...
// A2A Protocol endpoints - require A2A.Reviewer.Access role
var auth = new AuthorizeAttribute { Roles = AuthRoles.A2AReviewerAccess };
...
app.MapGet("/", () => "Reviewer Agent v2.0 (A2A) is running. Endpoint: /.well-known/agent.json");
